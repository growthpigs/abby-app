...
half4 main(float2 xy) {
  ...
  // Complexity controls animation speed (0.0 = slow/calm, 1.0 = fast/energetic)
  float speed = mix(0.05, 0.25, u_complexity);  // SMOOTHIE=0.15, PAISLEY=0.6
  ...
  // Slowly oscillating gradient (darkens one edge, drifts diagonally)
